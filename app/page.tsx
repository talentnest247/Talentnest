...
import { Star, Users, Shield, MessageCircle, Search, BookOpen, Sparkles } from "lucide-react"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="scroll-animate relative">
              ...
              <img
                src="/students-working-on-skills.png"
                alt="University of Ilorin students collaborating on projects"
